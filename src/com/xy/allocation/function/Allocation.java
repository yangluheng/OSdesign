...
public class Allocation {
     ...
     * @Date: 2019/12/15 0015
    **/
    public LinkedList<Zone> doAllocation(int size, int location, Zone tmp,LinkedList<Zone> zones){
     ...
     * @Date: 2019/12/15 0015
    **/
    public LinkedList<Zone> doCollection(int id,LinkedList<Zone> zones){
        if (id>=zones.size()){
     ...
     * @Date: 2019/12/15 0015
    **/
    public void printZones(LinkedList<Zone> zones){
    ...
    **/
     ...
     * @Date: 2019/12/15 0015
    **/
    public LinkedList<Zone> FF(int size,LinkedList<Zone> zones){
        ...
        for (pointer=0; pointer <zones.size() ; pointer++) {
            ...
            if (size<=tmp.getZoneSize()&&tmp.isFree()){ //找到可用分区
                doAllocation(size,pointer,tmp,zones);
                return zones;
            }
        }
     ...
     * @Date: 2019/12/15 0015
    **/
    public LinkedList<Zone> NF(int size,LinkedList<Zone> zones){
...
//        }
     ...
     * @Date: 2019/12/15 0015
    **/
    public LinkedList<Zone> BF(int size,LinkedList<Zone> zones){
        ...
        if (minPointer==-1){
            ...
            doAllocation(size,minPointer,zones.get(minPointer),zones);
        }
        return zones;
    }
     ...
     * @Date: 2019/12/15 0015
    **/
    public LinkedList<Zone> WF(int size,LinkedList<Zone> zones){
        ...
        if (maxPointer==-1){
            ...
            doAllocation(size,maxPointer,zones.get(maxPointer),zones);
        }
        return zones;
    }
}
