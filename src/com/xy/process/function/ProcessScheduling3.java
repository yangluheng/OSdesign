 ...
 * @Version V1.0
 **/
public class ProcessScheduling3 {
     ...
     * @Date: 2019/11/29 0029
     **/
    public void init(int processNum,int[] arriveTime,int[] serveTime,int[] priority) {
        processes = new ArrayList<>();
        processesQueue = new LinkedList<>();
        processesSort = new ArrayList<>();
        System.out.println("init");
        for (int i = 0; i < processNum; i++) {
            processes.add(new Process(String.valueOf(i+1),arriveTime[i],serveTime[i],priority[i]));
        }
...
//        processQueue.printProcess();
     ...
     * @Date: 2019/11/29 0029
     **/
    public  ArrayList<Process> RR(double sliceTime) {
        ProcessQueue pq = new ProcessQueue();
        pq.nowTime=processes.get(0).getArriveTime();
        pq.EnQueue();
...
//                        nowTime++;
            ...
            public void printProcess() {
                ...
                for (int i = 0; i < processesSort.size(); ++i) {
                    ...
                    aveRoundTime= Double.parseDouble(String.format("%.2f",aveRoundTime));
                ...
                averageRoundTime= Double.parseDouble(String.format("%.2f",averageRoundTime));
                averageWeightRoundTime= Double.parseDouble(String.format("%.2f",averageWeightRoundTime));
